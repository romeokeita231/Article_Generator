...
/** 创建用户（管理员） 创建用户（管理员） POST /user/add */
...
/** 删除用户（管理员） 删除用户（管理员） POST /user/delete */
...
/** 根据 ID 获取用户信息 根据用户 ID 获取用户信息 GET /user/get */
...
/** 分页查询用户列表（管理员） 分页查询用户列表（管理员） POST /user/list */
...
/** 获取当前登录用户 获取当前登录用户信息 GET /user/login */
...
/** 更新用户（管理员） 更新用户（管理员） POST /user/update */
